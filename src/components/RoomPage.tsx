  ...
  if (room === undefined) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="animate-pulse text-[var(--text-tertiary)]">Loading room...</div>
      </div>
    )
  }
  ...
  if (room === null) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-[var(--text-secondary)]">This room might have expired or never existed.</p>
        <a href="/" className="mt-6 text-[var(--accent)] hover:underline font-semibold">
          Return Home
        </a>
      </div>
    )
      ...
      <div className="grid gap-8 lg:grid-cols-4">
        <section className="lg:col-span-3">
          <div className="island-shell min-h-[400px] flex items-center justify-center border-2 border-dashed border-[var(--border-subtle)] rounded-[2rem]">
            <div className="text-center text-[var(--text-tertiary)]">
              ...
              <p className="text-sm italic">Coming soon: Feature implementation in progress</p>
            </div>
          </div>
        </section>
        ...
        <aside>
          <div className="island-shell p-6 rounded-2xl h-full">
            ...
            <div className="space-y-3 italic text-sm text-[var(--text-tertiary)]">
              Loading player list...
            </div>
          </div>
        </aside>
